    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <Link to="/" className="flex items-center gap-2 group">
          <div className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-red-600 via-red-500 to-rose-600 text-white shadow-lg transition-transform group-hover:scale-105">
        ...
        <nav className="hidden gap-8 md:flex items-center">
          ...
          <div className="relative">
            <input
              ...
              className="h-9 w-64 rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm text-slate-900 focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500"
              onKeyDown={(e) => {
                if (e.key === 'Enter') {
          ...
          {isAuthenticated ? (
            ...
            <>
              ...
              <Button
                ...
                className="bg-red-600 hover:bg-red-700 text-white shadow-lg shadow-red-200 transition-all hover:shadow-red-300 hover:-translate-y-0.5"
              >
                Get Started
              </Button>
            </>
